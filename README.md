...
Branch:
-master-> All final documentation (delivrable,capella, Fast,block_diagrams and capella), marketing video and poster (summarizing system operation)
-PID	-> Source code for the PID controller
-ball_detect	-> Image-processing code for ball detection
-global_code	-> Integrated final code (Image processing + PID + motor control)
